...
router.post('/request-recipient', async (req, res) => {
  try {
    ...
    try {
      ...
      // We use dynamic import because it's an ESM module
    ...
    // Store the request in a database (could create a separate model for this)
    // For simplicity, we're just handling the notification part here
